    ...
    internal sealed partial class DashboardWindow : PanelContainer
    {
        ...
        private static int DashboardOrder(string dashboardId)
        {
            return dashboardId switch
            {
                ...
                BuiltInDashboardIds.PlayerPerformance => 1,
                BuiltInDashboardIds.ReceivedDamage => 2,
                BuiltInDashboardIds.SourceAnalysis => 3,
                BuiltInDashboardIds.DefenseResources => 4,
                BuiltInDashboardIds.CardsAndEffects => 5,
                BuiltInDashboardIds.ContributionAnalysis => 6,
                BuiltInDashboardIds.TurnAnalysis => 7,
                BuiltInDashboardIds.RunTrends => 8,
                BuiltInDashboardIds.CombatRecords => 9,
                BuiltInDashboardIds.DamageContribution => 10,
                BuiltInDashboardIds.EffectiveHpDamageContribution => 11,
                BuiltInDashboardIds.DefenseContribution => 12,
                BuiltInDashboardIds.Meter => 13,
                BuiltInDashboardIds.CardLog => 14,
                BuiltInDashboardIds.Timeline => 15,
                BuiltInDashboardIds.DamageBreakdown => 16,
                _ => 100,
            };
        }
