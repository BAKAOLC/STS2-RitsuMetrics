...
namespace STS2RitsuMetrics.Api
{
    public static class MetricIds
    {
        ...
        public const string CardsExhausted = "core.card.exhausted";
        public const string EnergySpent = "core.energy.spent";
        public const string PotionsUsed = "core.potion.used";
        public const string PowersApplied = "core.power.applied";
        public const string DebuffsApplied = "core.debuff.applied";
        public const string OrbsChanneled = "core.orb.channeled";
        public const string StarsGained = "core.star.gained";
        public const string StarsSpent = "core.star.spent";
        public const string SummonsCreated = "core.summon.created";
    }
}
